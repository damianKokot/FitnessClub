...
INSERT INTO users(firstname, lastname, email, telephone, password) VALUES("user","user","user@user.com","123465689","$2b$10$yMzxn4pI2IIMsn5vh6GRB.8VY27M6RlcDkoE32UtH1W1HqB4L8H4S");
INSERT INTO users(firstname, lastname, email, telephone, password, permissions) VALUES("Emil", "Brzoza", "emil@gmail.com", "123456789", "$2b$10$b10jKr/w8BIxrMGTzvD8fuy0dTmR/U7SPSL9lDV3wo.t0kFNn.SSy", "trainer");
INSERT INTO users(firstname, lastname, email, telephone, password, permissions) VALUES("Enrica","Nealey","enealey0@nymag.com","939-676-0453","$2b$10$6TB4YrZ6qApSFGil63KJrejyLzrDYE.bakowBedunCQSd1FKVrsMe", "trainer");
INSERT INTO users(firstname, lastname, email, telephone, password, permissions) VALUES("Carrol","Caseborne","ccaseborne3@google.de","738-512-2644","$2b$10$PGxWWruw4AnUqLcCCQh6MOmXMvc.ZLEHznlVPlnmrrbDUx1WvN0by", "trainer");
...
INSERT INTO specific_classes(trainer_id, class_id, start, max_participants) VALUES(4, 3, '2020-10-10 10:00:00', 20);